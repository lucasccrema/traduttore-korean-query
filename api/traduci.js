...
export default async function handler(req, res) {
  ...
  body: JSON.stringify({
    model: "gpt-4o-mini",
    messages: [
      { role: "system", content: "Sei un insegnante di Coreano. Devi rispondere con la traduzione in italiano;  vai a capo e poi dai spiegazioni grammaticali. Non usare romanizzazione , bensì fonetica IPA" },
